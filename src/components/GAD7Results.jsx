...
export default function GAD7Results({ answers, questions, lang, t, onBack, toggleLang, onSave }) {
        ...
        {showLive && (
          ...
          <div className="space-y-3">
            {questions.map((q, i) => {
              ...
              return (
                <div key={i} className="p-3 rounded-xl border border-white/[0.05] bg-white/[0.02]">
